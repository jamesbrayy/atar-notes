...
* mechanical advantage is defined as the ratio of the load to the effort.
    * it is calculated with $$\text{MA}=\frac{F_{load}}{F_{effort}}$$ 
...
* $$v_{output} = \frac{v_{input}}{\text{VR}}$$
* $$v=\frac{s}{t}$$
